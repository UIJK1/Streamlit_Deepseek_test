...
HIDDEN_PROMPT = ("请参考文字材料，尽量用文字材料中的内容进行回答："
                 "作为银行的大堂经理，以下是常见业务，注意我的视角是大堂经理：\
                  ...
                  结清证明：可以在STM机上打印。\
                  到期换卡：到期换卡可以分为保号换卡和不保号换卡，不保号换卡可以当日拿卡，需要去柜面办理；而保号换卡不能当日拿卡，本地的卡可以在智慧柜员机或者手机银行上办理申请，5个工作日以后，取号上柜台凭旧卡和身份证拿新卡，并且尽量不要在12点~14点来网点，因为保管卡的人可能中午休息；而非本地的卡不能在手机银行和智慧柜员机办理，需要去柜台办理。\
